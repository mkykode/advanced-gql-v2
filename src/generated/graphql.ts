...
import type { User as UserModel, Post as PostModel, Settings as SettingsModel, Invite as InviteModel, Context } from '../types.ts';
...
export type FormatDateDirectiveResolver<Result, Parent, ContextType = Context, Args = FormatDateDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type LogDirectiveArgs = {
  message?: Maybe<Scalars['String']['input']>;
};

export type LogDirectiveResolver<Result, Parent, ContextType = Context, Args = LogDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type TruncateDirectiveArgs = {
  ellipsis?: Maybe<Scalars['String']['input']>;
  length?: Scalars['Int']['input'];
};

export type TruncateDirectiveResolver<Result, Parent, ContextType = Context, Args = TruncateDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type InviteResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Invite'] = ResolversParentTypes['Invite']> = {
...
export type MutationResolvers<ContextType = Context, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  invite?: Resolver<ResolversTypes['Invite'], ParentType, ContextType, RequireFields<MutationInviteArgs, 'input'>>;
...
export type DirectiveResolvers<ContextType = Context> = {
  ...
  truncate?: TruncateDirectiveResolver<any, any, ContextType>;
};
